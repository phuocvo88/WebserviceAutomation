...
{
    [TestFixture]
    public class WINSWTestCase : BaseTest
    {
        ...
        public void TC19()
        {
            ...
            string httpResponse = CommonFunctions.CommonFunctions.SendPostRequestAndGetResponseAsString_WINSW(requestObjPost, TCname);
